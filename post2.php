    ...
    <div class="container datadivi" id="datadivi">
        <div class="row">
            <div class="center">
                ...
                ?>
                <div class="col l6 offset-l3">     <h5 class="card"> Bonjour<span class="red-text"><?php if(isset($_SESSION['username'])){echo ' '.htmlentities($_SESSION['username'], ENT_QUOTES, 'UTF-8');} ?></span>, <br/>  veuillez lire les <span class="blue-grey-text">termes et conditions</span><br/> juste à votre droite </h5><br /></div>
                    ...
                    <div class="container ">
                        <div class="row">
                            ...
                            <div class="z-depth-5">
                                ...
                                <div class="col l6  center-align card">
