    ...
    <div class="container datadivi" id="datadivi">
        <div class="row">
            <div class="center">
                ...
                ?>
                <div class="col l6 offset-l3">     <h5 class="card"> Bonjour<span class="red-text"><?php if(isset($_SESSION['username'])){echo ' '.htmlentities($_SESSION['username'], ENT_QUOTES, 'UTF-8');} ?></span>, <br/>  veuillez <a href="#termes">lire</a> les <span class="blue-grey-text">termes et conditions</span><br/> </h5><br /></div>
                    ...
                    <div class="container ">
                        <div class="row">
                                ...
                                <form method="post" enctype="multipart/form-data" id="uploadForm2">
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="input-field col l6 s12">
                                            ...
                                            <label for="artiste">Nom de l'artiste de la chanson</label>
                                        </div>
                            ...
                            <div class="z-depth-5">
                                ...
                                <div class="col l6  center-align card" id="termes">
                                    <h3>Termes et Conditions</h3>
                                    <p>
                                        Katanga music est un site libre en chargement et telechargement de videos et audios
                                        ce site est fait principalement pour les artistes faisant de la musique katangaise.<br/>
                                        En postant une chanson sur ce site nous reconnaissons que<span class="spanrouge"> l'auteur                               ou l'artiste de la chanson
